...
/* harmony import */ var _modules_accordion_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/accordion-menu.js */ "./js/modules/accordion-menu.js");
/* harmony import */ var _modules_hide_button_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/hide-button.js */ "./js/modules/hide-button.js");
/* harmony import */ var _utils_phone_check_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/phone-check.js */ "./js/utils/phone-check.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_hide_button_js__WEBPACK_IMPORTED_MODULE_3__["initHideButton"])();
    Object(_modules_accordion_menu_js__WEBPACK_IMPORTED_MODULE_2__["initAccordionMenu"])();
    Object(_utils_phone_check_js__WEBPACK_IMPORTED_MODULE_4__["initPhoneCheck"])();
  });
});
...
/***/ "./js/modules/accordion-menu.js":
/*!**************************************!*\
  !*** ./js/modules/accordion-menu.js ***!
  \**************************************/
/*! exports provided: initAccordionMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAccordionMenu", function() { return initAccordionMenu; });
var footer = document.querySelector('[data-id="footer"]');
var accordionButtons = document.querySelectorAll('[data-id="nav-toggle"]');
var changeButtonState = function changeButtonState(element) {
  if (element.getAttribute('data-state') === 'is-closed') {
    element.setAttribute('data-state', 'is-opened');
    accordionButtons.forEach(function (anotherElement) {
...
var initAccordionMenu = function initAccordionMenu() {
...
/***/ "./js/modules/hide-button.js":
/*!***********************************!*\
  !*** ./js/modules/hide-button.js ***!
  \***********************************/
/*! exports provided: initHideButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHideButton", function() { return initHideButton; });
var hidingAreas = document.querySelectorAll('[data-id="to-hide"]');
var hideButtons = document.querySelectorAll('[data-id="hide-button"]');
var hideAreas = function hideAreas() {
  hidingAreas.forEach(function (element) {
    element.setAttribute('data-state', 'is-hidden');
  });
};
var showAreas = function showAreas() {
  hidingAreas.forEach(function (element) {
    element.setAttribute('data-state', '');
  });
};
var changeContent = function changeContent(element) {
  if (element.getAttribute('data-state') === 'is-closed') {
    showAreas();
    element.setAttribute('data-state', 'is-opened');
...
var initHideButton = function initHideButton() {
  hideAreas();
...
/***/ "./js/utils/phone-check.js":
/*!*********************************!*\
  !*** ./js/utils/phone-check.js ***!
  \*********************************/
/*! exports provided: initPhoneCheck */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPhoneCheck", function() { return initPhoneCheck; });
...
var initPhoneCheck = function initPhoneCheck() {
